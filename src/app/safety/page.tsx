      ...
      sections={[
        {
          ...
          body: 'How we verify identity and protect your personal information on the campus marketplace.',
          subsections: [
            {
        ...
        {
          heading: 'Safe Transactions',
          body: 'Steps to take during conversations and physical exchanges to guarantee a secure experience.',
          subsections: [
            {
        ...
        },
        {
          ...
          body: 'Resources and collective efforts to support safety across all campus swap activities.',
          subsections: [
            {

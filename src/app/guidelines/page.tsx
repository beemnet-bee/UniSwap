  ...
  return (
    <LegalPage
      ...
      sections={[
        {
          heading: 'Our Values',
          body: 'We believe that a healthy, thriving community starts with simple, shared standards of behavior.',
          subsections: [
            {
        ...
        },
        {
          ...
          body: 'To protect the community, we follow communication norms that keep student exchanges transparent and verified.',
          subsections: [
            {
        ...
        },
        {
          ...
          body: 'Clear guidelines that protect students from risk and maintain a safe academic environment.',
          subsections: [
            {
